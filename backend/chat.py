    ...
    try:
        ...
        for conv in conversaciones:
            ...
            with conexion.cursor(pymysql.cursors.DictCursor) as cursor:
                ...
                if usuario_info:
                    # Limpiar valores None o 'None' en strings
                    primer_nombre = usuario_info['primer_nombre']
                    if primer_nombre in (None, 'None', 'none', 'null', ''):
                        primer_nombre = ''
                    
                    primer_apellido = usuario_info['primer_apellido']
                    if primer_apellido in (None, 'None', 'none', 'null', ''):
                        primer_apellido = ''
                    
                    # Construir nombre completo o usar username
                    nombre_completo = f"{primer_nombre} {primer_apellido}".strip()
                    if not nombre_completo:
                        nombre_completo = usuario_info["username"]
